package net.mrchar.peach.authorization.domain.user.service.impl;
...
import net.mrchar.peach.authorization.domain.user.model.EmailEntity;
...
import net.mrchar.peach.authorization.domain.user.repository.EmailRepository;
import net.mrchar.peach.authorization.domain.user.repository.PhoneRepository;
